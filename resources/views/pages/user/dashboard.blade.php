                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="card border-info">
                                        <div class="card-body">
                                            <h5 class="card-title">
                                                <i class="fas fa-laptop"></i> Daftar PC
                                            </h5>
                                            <p class="card-text small">Lihat daftar PC yang tersedia untuk dipinjam</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="card border-success">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text small">Lihat daftar PC yang sedang Anda pinjam</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <a href="{{ route('user.pcs.index') }}" class="list-group-item list-group-item-action">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="text-muted">Lihat PC yang tersedia</small>
                                        </div>
                                    </div>
                                </a>
