                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tr><td><strong>PC</strong></td><td>{{ $return->borrowing->pc->pc_name ?? '-' }} ({{ $return->borrowing->pc->pc_code ?? '-' }})</td></tr>
                                <tr><td><strong>Ruangan</strong></td><td>{{ $return->borrowing->pc->room->room_name ?? '-' }}</td></tr>
