<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="dropdown {{ request()->routeIs('admin.pcs.*') ? 'active' : '' }}">
        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-laptop"></i> <span>PC</span></a>
        <ul class="dropdown-menu">
          <li class="{{ request()->routeIs('admin.pcs.index') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.pcs.index') }}">Daftar PC</a></li>
          <li class="{{ request()->routeIs('admin.pcs.create') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.pcs.create') }}">Tambah PC</a></li>
        </ul>
      </li>
