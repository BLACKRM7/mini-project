            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Dashboard admin ini memberikan akses penuh untuk mengelola sistem peminjaman PC, user, dan semua fitur administrasi lainnya.</p>
                ...
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="card bg-info text-white">
                        <div class="card-header">
                            <h4 class="text-white">Total PC</h4>
                        </div>
                        <div class="card-body">
                            <div class="row align-items-flex-end">
                                <div class="col col-stats ms-3 ms-xl-0">
                                    <div class="numbers">
                                        <p class="state text-truncate text-secondary text-white-80">PC Terdaftar</p>
                                        <h3 class="counter text-white">{{ \App\Models\PC::count() }}</h3>
                                    </div>
                                </div>
                                <div class="col col-stats text-white text-end">
                                    <div class="chartjs-wrapper h-5rem">
